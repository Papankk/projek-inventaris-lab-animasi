                                        ...
                                        <div class="p-3 table-responsive">
                                            <table id="myTable" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $no = 1;
                                                    $query_select = mysqli_query($connect, "SELECT * FROM tbl_jdl_pengajuan");
                                                    while ($row = mysqli_fetch_assoc($query_select)) {
                                                        echo '<tr>';
                                                        echo '<td>' . $no++ . '</td>';
                                                        echo '<td>' . $row['nama'] . '</td>';
                                                        echo '<td>' . $row['nodok'] . '</td>';
                                                    ?>
                                                        <td>
                                                            <div class="d-grid gap-2 col-5 mx-auto">
                                                                <a href="detail.php?id=<?= $row['id_judul'] ?>" class="btn btn-sm btn-primary">Detail</a>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="delete.php">
                                                                            ...
                                                                            <input type="hidden" name="idjudul" id="username" value="<?= $row['id_judul'] ?>">
                                                                            <input type="hidden" name="nama" id="username" value="<?= $row['nama'] ?>">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="update.php">
                                                                            ...
                                                                            <input type="hidden" name="idjudul" value="<?= $row['id_judul'] ?>">
                                                                            <div class="input-group mb-3">
                                                                                <span class="input-group-text cursor-pointer"><i class="bx bx-chevrons-right"></i></span>
                                                                                <input type="text" name="judul" class="form-control" value="<?= $row['nama'] ?>" required />
                                                                            </div>
                                                                            <label class="form-label">No. Dok</label>
                                                                            <div class="input-group mb-3">
                                                                                <span class="input-group-text cursor-pointer"><i class="bx bx-file"></i></span>
                                                                                <input type="text" name="nodok" class="form-control" id="text" value="<?= $row['nodok'] ?>" required />
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="insert.php">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text cursor-pointer"><i class="bx bx-chevrons-right"></i></span>
                                                <input type="text" name="judul" class="form-control" placeholder="Judul Pengajuan" required />
                                            </div>
                                            <label class="form-label">No. Dok</label>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text cursor-pointer"><i class="bx bx-file"></i></span>
                                                <input type="text" name="nodok" class="form-control" id="text" placeholder="No. Dok" required />
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button name="submitinsert" type="submit" class="btn btn-primary">Save changes</button>
