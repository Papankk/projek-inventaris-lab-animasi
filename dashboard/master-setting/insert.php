...
$queryupdate = mysqli_query($connect, "UPDATE tbl_setting SET nama_sarpras = '$nama_sarpras', nip_sarpras = '$nip_sarpras', nama_kepsek = '$nama_kepsek', nip_kepsek = '$nip_kepsek'");
