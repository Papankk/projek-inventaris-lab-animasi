...
$queryvalue = mysqli_query($connect, "SELECT * FROM tbl_setting");
$fetch = mysqli_fetch_assoc($queryvalue);
...
?>
    ...
    <head>
        ...
        <title>Dashboard - Master Setting</title>
                                            ...
                                            <div class="p-3">
                                                <div class="row">
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <div class="col-auto">
                                                            <input type="text" name="nama_sarpras" id="inputtext6" class="form-control" aria-describedby="textHelpInline" value="<?= $fetch['nama_sarpras'] ?>">
                                                        </div>
                                                        <div class="col-auto">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <div class="col-auto">
                                                            <input type="text" name="nama_kepsek" id="inputtext6" class="form-control" aria-describedby="textHelpInline" value="<?= $fetch['nama_kepsek'] ?>">
                                                        </div>
                                                        <div class="col-auto">
                                                            <label for="inputtext6" class="col-form-label">NIP</label>
                                                        </div>
